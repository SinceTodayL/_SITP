...
file_path = "E:\_SITP\data\Label\label_2class.xlsx"  # Replace with your actual file path
...
class_proportions = counts / len(real_labels)  # Proportions of 0, 1
print(f"Class Proportions in Real Labels: 0 -> {class_proportions[0]:.4f}, 1 -> {class_proportions[1]:.4f}")
...
predicted_labels[sorted_indices[:num_class_0]] = 0  
predicted_labels[sorted_indices[num_class_0:]] = 1  
...
# ----------------------------
precision_macro = precision_score(real_labels, predicted_labels, average='macro', labels=[0, 1])
recall_macro = recall_score(real_labels, predicted_labels, average='macro', labels=[0, 1])
f1_macro = f1_score(real_labels, predicted_labels, average='macro', labels=[0, 1])
precision_weighted = precision_score(real_labels, predicted_labels, average='weighted', labels=[0, 1])
recall_weighted = recall_score(real_labels, predicted_labels, average='weighted', labels=[0, 1])
f1_weighted = f1_score(real_labels, predicted_labels, average='weighted', labels=[0, 1])
...
conf_matrix = confusion_matrix(real_labels, predicted_labels, labels=[0, 1])
plt.figure(figsize=(8, 6))
sns.heatmap(conf_matrix, annot=True, fmt="d", cmap="Blues", xticklabels=["Normal", "Minor Anomaly"], yticklabels=["Normal", "Minor Anomaly"])
