...
# 使用Random Forest的OneVsRestClassifier来确保三分类
model_layer1_rf = OneVsRestClassifier(RandomForestClassifier(n_estimators=100, random_state=42))
model_layer2_rf = OneVsRestClassifier(RandomForestClassifier(n_estimators=100, random_state=42))
